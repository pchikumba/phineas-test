...
public class Recommender implements Serializable {
   ...
   return  nameofRec;
    ...
    public boolean equals(Object object) {
        ...
        Recommender other = (Recommender) object;
    ...
    public String toString() {
        return "zw.co.hitrac.support.business.domain.Nutrition.Recommender[ id=" + id + " ]";
    }
