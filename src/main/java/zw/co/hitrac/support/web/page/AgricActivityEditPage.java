...
public class AgricActivityEditPage extends TemplatePage {
    ...
    public AgricActivityEditPage(PageParameters parameters) {
        ...
        agricactivityModel = new AgricActivityModel(null);
        agricactivityModel.getObject().setDemographic(demographicService.find(id));
        ...
        form.add(new org.apache.wicket.markup.html.form.Button("submit") {
            ...
            public void onSubmit() {
                ...
                agricactivity.setDemographic(demographicService.find(id));
