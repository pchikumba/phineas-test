package zw.co.hitrac.support.web.page.panel;
...
/**
 *
 * @author morris tonderai ndangana
...
public class LoginPanel extends Panel {
    ...
    public final class SignInForm extends StatelessForm<Void> {
        ...
        public final void onSubmit() {
            ...
            SupportSession session = getMySession();
        ...
        private SupportSession getMySession() {
            return (SupportSession) getSession();
        }
    }
